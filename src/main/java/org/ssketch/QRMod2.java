...
public class QRMod2 implements Serializable {

	private final static Logger log = LoggerFactory.getLogger(QRMod2.class);// getLogger(SparkPCA.class);
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		SparkConf conf = new SparkConf().setAppName("QRMod2");//.setMaster("local[*]");//
		// TODO
		// remove
		// this
		// part
